...
ttop = tk.Frame(root, width=50,bg='#d3d3d3', height=50, pady=4)
ttop.grid(row=0, column=0, sticky=tk.NSEW)

tbtn = tk.Frame(root, width=50,bg='#d3d3d3', height=50, pady=4)
...
#Set up labels
TMCodeLB = tk.Label(ttop, text='Transection Code : ',bg='#d3d3d3')  # More labels =""
#TMMCodeLB = tk.Label(ttop, text='Merchant Code : ',bg='khaki2')  # More labels=""
TMMNameLB = tk.Label(ttop, text='Merchant Name : ',bg='#d3d3d3')  # More labels=""
TMStateLB = tk.Label(ttop, text='State : ',bg='#d3d3d3')  # More labels=""
TMMSiteLB = tk.Label(ttop, text='Address\Site Name: ',bg='#d3d3d3')  # More labels=""
Trans_AmtLB = tk.Label(ttop, text='Purchase Amount : ',bg='#d3d3d3')  # More labels=0
DCoLB0 = tk.Label(ttop, text='----------------',fg='brown',bg='#d3d3d3',font=('times', 18,' bold '))  # ^
DCoLB1 = tk.Label(ttop, text='--------------------------------------------------------------------------------------',fg='brown',bg='#d3d3d3',font=('times', 18,' bold '))  # ^

TCCNoLB = tk.Label(ttop, text='Credit Card No : ',bg='#d3d3d3')  # More labels""
TCCPinLB = tk.Label(ttop, text='PIN : ',bg='#d3d3d3')  # More labels=""

DCoLB2 = tk.Label(ttop, text='----------------',fg='brown',bg='#d3d3d3',font=('times', 18,' bold '))  # ^
DCoLB3 = tk.Label(ttop, text='--------------------------------------------------------------------------------------',fg='brown',bg='#d3d3d3',font=('times', 18,' bold '))  # ^

ClrB = tk.Button(ttop, text='Clear',bg='#FFD700', fg='black',command=Clear_entry,width=10) 
ProcB = tk.Button(ttop, text='Process Details',bg='#FFD700', fg='black',command=proc_detail,width=15) 
# Place Clear and Process Details buttons side by side with equal space in between
ClrB.grid(row=11, column=0, padx=(5, 2), sticky=tk.W)
ProcB.grid(row=11, column=1, padx=(2, 5), sticky=tk.W)


DCoLB4 = tk.Label(ttop, text='----------------',fg='brown',bg='#d3d3d3',font=('times', 18,' bold '))  # ^
DCoLB5 = tk.Label(ttop, text='--------------------------------------------------------------------------------------',fg='brown',bg='#d3d3d3',font=('times', 18,' bold '))  # ^


ProcInfoLB= tk.Label(ttop, text='----------------------Information-----------------------',fg='brown',bg='#d3d3d3',font=('times', 15,' bold '))  # ^
# Place the Information label below the buttons
ProcInfoLB.grid(row=12, column=0, columnspan=2, sticky=tk.W, pady=(10, 0))

TM_StatusLB = tk.Label(ttop, text='Status : ',bg='khaki2')  # More labels=""


TMInfoLB = tk.Label(ttop, text='------------Result---------------',fg='brown',bg='#d3d3d3',font=('times', 15,' bold '))  # ^
...
BuyB = tk.Button(ttop, text='Purchase',bg='#FFD700', fg='black',command=SaveDetails,width=15) 
...
ExtB = tk.Button(tbtn, text='Exit',bg='#FFD700', fg='black',
