...
class main:
 ...
 # , relwidth=1, relheight=1)
    ...
    # Draw Widgets
    def widgets(self):
        self.head = tk.Label(self.master, text='Welcome To Login', background="#FFDAB9", font=('Times New Roman', 20),
                             pady=20)
        self.head.pack()
        ...
        # self.head.pack()
        self.logf = tk.Frame(self.master, padx=50, pady=20, background="#FFDAB9")
        tk.Label(self.logf, text='Username: ', background="#FFDAB9", font=("Times New Roman", 20), pady=5,
                 padx=5).grid(sticky=tk.W)
        tk.Entry(self.logf, textvariable=self.username, bd=5, background="white", font=('', 15)).grid(row=0, column=1)
        tk.Label(self.logf, text='Password: ', background="#FFDAB9", font=("Times New Roman", 20), pady=5,
                 padx=5).grid(sticky=tk.W)
